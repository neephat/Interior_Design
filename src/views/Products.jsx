...
const Products = () => {
  return (
    <div 
    id="products" 
    className="flex flex-col 2xl:flex-row gap-[80px] 2xl:gap-2 2xl:justify-between mt-[160px] 2xl:mt-[270px] mb-[40px]
    ...
    >
      <FadeIn delay={0.2} direction="right">
        <div className="flex flex-col">
          ...
          <button 
            className="flex items-center gap-2 bg-transparent text-fontBlack border-transparent font-bold py-2 px-4 rounded-lg w-fit 
            border hover:border-black outline-none focus:outline-none ease-linear transition-all duration-350 mx-auto 2xl:mx-0 mb-10 2xl:mb-0"
          >
        ...
        {products.map((product, index)=>(
          <FadeIn key={index} delay={(index+1)*0.2} direction="left" fullWidth>
            <div className="h-[510px] relative flex-1 bg-[#C1D0E4] rounded-[50px] max-w-[500px]">
              <img src={product.img} alt="" className="absolute -top-[80px] xs:-top-[100px] left-1/2 -translate-x-1/2" />
